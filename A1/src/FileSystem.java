...
public class FileSystem {
	...
	public static Path path = Paths.get("TelefonEntries.json");
	
	public static List<TelefonEntry> readEntriesFromFile(Path telBookPath) {
		if(telBookPath == null)	{
			return null;
		}
		List<TelefonEntry> entries = new ArrayList<>();
		try (InputStream is = Files.newInputStream(telBookPath)) {
